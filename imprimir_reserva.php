...
$consulta8 = "SELECT * FROM vehiculo WHERE id_vehiculo = ${id_vehiculo}";
$resultado8 = mysqli_query($db, $consulta8);
$vehiculo8 = mysqli_fetch_assoc($resultado8);
$marca = $vehiculo8['marca'];
$modelo = $vehiculo8['modelo'];
$ano = $vehiculo8['ano'];
$color = $vehiculo8['color'];
$patente = $vehiculo8['patente'];
$imagen = $vehiculo8['imagen'];
$valor = $vehiculo8['valor'];
if($_SERVER['REQUEST_METHOD'] === 'POST'){
	...
	if($resultado_disponibilidad2['disponible'] == "si"){
		...
		$resultado_pagar = $numeroDias * $valor;
	...
	<div class="redondear marco_crear form-container" >
		<form action="transbank-pay.php" enctype="multipart/form-data" method="GET" id="miFormulario">
				<table borde>
					...
					<br>
					<div class="centrar">
						<img src= "imagenes_vehiculos\<?php echo $imagen ?>" width="50%"  >	
					</div>
					<br>
					<tr>
					...
					<tr>
						<td>Observaciones: </td>
						<td><textarea name id="" cols="35" rows="5"><?php echo $obs; ?></textarea></td>
					</tr>	
