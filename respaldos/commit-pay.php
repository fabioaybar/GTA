...
<head>
    ...
    <link rel="stylesheet" href="assets/bootstrap/bootstrap-5.1.3/css/bootstrap.min.css">
    
</head>

<body>
    <div class="container-sm m-auto my-5">
    ...
    function commitTransactionTransbank($tokenWs)
    {
        try {
            ...
            if ($jsonResponse !== null) {
                ...
                ?><div>
                     <button class="btn btn-primary" style="width: 30%;" onclick="printData()">Imprimir</button>
                    </div>
                    <br>
                    <div>
    ...
    <script>
        function printData() {
            var printContents = document.getElementById("transaction-details").innerHTML;
